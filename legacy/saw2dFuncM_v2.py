...
def saw2dFuncM(coordinate_init, occupied_coordinate_list, N):
    ...
    while num < N:
        ...
        while rep < 20 and num < N:
            ...
            if coordinate_temp in occupied_coordinate_list:
                num = num
                num_list.append(num)
    ...
    coordinateXY_list = [x_list, y_list]

    return coordinate_list, coordinateXY_list